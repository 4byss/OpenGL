...
void display()
{
    ...
    point ctrlPts[4] = { {0.0, 190.0, 0.0}, {0.0, 70.0, 0.0},
                         {70.0, 70.0, 0.0}, {70.0, 0.0, 0.0} };
    ctrlPts[1].x +=10*sin(theta * PI/180.0);
    ctrlPts[1].y +=15*sin((theta-40) * PI/180.0);
    ctrlPts[2].x -= 20*sin((theta+20) * PI/180.0);
    ctrlPts[2].y -= 50*sin((theta+70) * PI/180.0);
    ctrlPts[3].x -= 25*sin((theta) * PI/180.0);
    ctrlPts[3].y += sin((theta-70) * PI/180.0);
    theta+=0.2;
    glClear(GL_COLOR_BUFFER_BIT);
...
int main(int argc, char **argv)
{
    ...
    glutCreateWindow("Indian Flag Animation");
    init();
